...
#define   __CONF_DFLAGS         " -D__FFTW3 -D__MPI -D__MPI_MODULE"
...
#define   __CONF_FFLAGS         "-O3 -g -fallow-argument-mismatch"
...
#define   __CONF_LAPACK_LIBS    "-L/usr/local/lib -llapack  -lblas "
