!----------------------------------------------------------------------------
SUBROUTINE my_setup_nscf ( newgrid, xq, elph_mat )
!----------------------------------------------------------------------------
  !
  ...
  write(*,*) 'nkstot after irreducible_BZ = ', nkstot
  !
  ...
  ENDIF
  write(*,*) 'nkstot after set_kplusq: ', nkstot
  !
