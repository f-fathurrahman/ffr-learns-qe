...
SUBROUTINE data_structure( gamma_only )
  ...
  write(*,*) 'gcutms = ', gcutms
  write(*,*) 'gcutm = ', gcutm
  write(*,*) 'gcut ratio = gcutm/gcutms = ', gcutm/gcutms
  write(*,*) 'gcut ratio = gcutm/gkcut = ', gcutm/gkcut
  write(*,*) 'dual for wave = gcutms/gkcut = ', gcutms/gkcut
  ...
  write(*,*) 'ngs_ = ', ngs_
  write(*,*) 'ngm_ = ', ngm_
  !stop 'ffr stop data_structure 89'
