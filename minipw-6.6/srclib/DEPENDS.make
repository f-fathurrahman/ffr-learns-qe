...
my_addusforce.o : my_addusforce.f90 fft_interfaces.o mp.o mp_pools.o mp_bands.o uspp.o uspp.o scf_mod.o noncol.o recvec.o fft_base.o cell_base.o realus.o control_flags.o ions_base.o kind.o 
...
my_compute_deff.o : my_compute_deff.f90 noncol.o pwcom.o pwcom.o uspp.o uspp.o ions_base.o kind.o 
...
my_force_corr.o : my_force_corr.f90 mp.o mp_bands.o wavefunctions.o control_flags.o scf_mod.o pwcom.o recvec.o fft_interfaces.o fft_base.o cell_base.o ions_base.o uspp.o atom.o constants.o kind.o 
my_force_lc.o : my_force_lc.f90 Coul_cut_2D.o esm.o fft_interfaces.o fft_base.o mp.o mp_bands.o constants.o kind.o 
my_forces.o : my_forces.f90 qmmm.o esm.o tsvdw.o xdm_dispersion.o dftd3_qe.o dftd3_api.o mm_dispersion.o martyna_tuckerman.o uspp.o bp_mod.o plugin_flags.o control_flags.o extfield.o ldaU.o scf_mod.o pwcom.o pwcom.o symme.o recvec.o fft_base.o ions_base.o cell_base.o io_global.o kind.o 
my_force_us.o : my_force_us.f90 mp.o mp_bands.o mp_pools.o becmod.o buffers.o io_files.o pwcom.o noncol.o wavefunctions.o symme.o pwcom.o pwcom.o uspp.o uspp.o recvec.o pwcom.o ions_base.o cell_base.o control_flags.o kind.o 
my_hinit0.o : my_hinit0.f90 noncol.o io_global.o control_flags.o ldaU.o realus.o pwcom.o recvec.o fft_base.o pwcom.o cell_base.o atomic_wfc_mod.o ions_base.o kind.o 
...
my_setlocal.o : my_setlocal.f90 Coul_cut_2D.o qmmm.o esm.o martyna_tuckerman.o mp.o mp_bands.o control_flags.o fft_interfaces.o fft_base.o pwcom.o scf_mod.o recvec.o extfield.o cell_base.o ions_base.o constants.o kind.o io_global.o 
