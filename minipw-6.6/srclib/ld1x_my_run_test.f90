...
1111 call mp_bcast(ios, ionode_id, world_comm)
  ...
  do nc=1,nconf
     ...
     nwfts=nwftsc(nc)
     if (nc>1) call my_save_ae(nwf_old,nn_old,ll_old,jj_old,enl_old,   &
...
SUBROUTINE my_save_ae(nwf_old,nn_old,ll_old,jj_old,enl_old,oc_old,isw_old, &
