...
110 format (5x, '  r < ',f4.2,' : rho core = a sin(br)/r    a=',f7.2,'  b=',f7.2/)
...
1100 continue
  ...
  if( file_core /= ' ') then
    ...
    if( ionode ) open(unit=26,file=file_core, status='unknown', iostat=ios, err=300 )
