...
SUBROUTINE my_stress( sigma )
  ...
  ELSE
    CALL my_stress_ewa( alat, nat, ntyp, ityp, zv, at, bg, tau, omega, g, &
  ...
  ELSE IF ( ldftd3 ) THEN
    ...
    CALL dftd3_pbc_gdisp( dftd3, tau, atnum, latvecs, force_d3, sigmad23 )
