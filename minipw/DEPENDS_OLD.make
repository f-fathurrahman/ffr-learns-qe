...
add_qexsd_step.o : add_qexsd_step.f90 qexsd.o extfield.o fcp_variables.o control_flags.o pwcom.o pwcom.o pwcom.o cell_base.o ions_base.o constants.o kind.o 
...
forces.o : forces.f90 qmmm.o esm.o tsvdw.o xdm_dispersion.o mm_dispersion.o martyna_tuckerman.o uspp.o bp_mod.o plugin_flags.o control_flags.o extfield.o ldaU.o scf_mod.o pwcom.o pwcom.o symme.o pwcom.o recvec.o fft_base.o ions_base.o cell_base.o io_global.o kind.o 
...
fox_init_module.o : fox_init_module.f90 mp_images.o io_global.o mp.o 
...
minipw.o : minipw.f90 laxlib_hi.fh laxlib_mid.fh laxlib_param.fh laxlib_kinds.fh laxlib_low.fh laxlib.fh read_input.o environment.o command_line_options.o mp_bands.o mp_pools.o mp_world.o mp_global.o 
...
punch.o : punch.f90 xdm_dispersion.o wavefunctions.o a2fmod.o io_rho_xml.o qexsd.o pw_restart_new.o ions_base.o pwcom.o scf_mod.o pwcom.o wrappers.o pwcom.o control_flags.o io_files.o io_global.o 
...
pw_init_qexsd_input.o : pw_init_qexsd_input.f90 qexsd_input.o qexsd_init.o qes_libs_module.o qes_types_module.o control_flags.o uspp.o funct.o cell_base.o ions_base.o constants.o parameters.o kind.o pwcom.o input_parameters.o 
pw_restart_new.o : pw_restart_new.f90 mp_images.o electrons_base.o tetra.o mp_global.o wrappers.o mp_pools.o wavefunctions.o buffers.o io_base.o run_info.o martyna_tuckerman.o esm.o Coul_cut_2D.o fcp_variables.o bfgs_module.o pwcom.o pwcom.o bp_mod.o input_parameters.o xdm_dispersion.o mm_dispersion.o exx.o exx_base.o mp_bands.o mp.o extfield.o pwcom.o scf_mod.o funct.o pwcom.o symm_base.o pwcom.o ldaU.o pwcom.o gvecw.o tsvdw.o pwcom.o pwcom.o recvec.o atomic_wfc_mod.o fft_base.o recvec.o start_k.o pwcom.o noncol.o ions_base.o cell_base.o uspp.o paw_variables.o uspp.o realus.o constants.o control_flags.o io_files.o io_global.o qexsd_copy.o qexsd_init.o qexsd_input.o qexsd.o qes_bcast_module.o qes_reset_module.o qes_write_module.o qes_types_module.o kind.o 
pwscf.o : pwscf.f90 laxlib_hi.fh laxlib_mid.fh laxlib_param.fh laxlib_kinds.fh laxlib_low.fh laxlib.fh command_line_options.o read_input.o mp_exx.o mp_bands.o mp_pools.o mp_world.o mp_global.o environment.o 
qes_bcast_module.o : qes_bcast_module.f90 mp.o io_global.o qes_types_module.o 
qes_init_module.o : qes_init_module.f90 qes_types_module.o kind.o 
qes_libs_module.o : qes_libs_module.f90 qes_write_module.o qes_read_module.o qes_reset_module.o qes_bcast_module.o qes_init_module.o 
qes_read_module.o : qes_read_module.f90 qes_types_module.o 
qes_reset_module.o : qes_reset_module.f90 qes_types_module.o 
qes_types_module.o : qes_types_module.f90 kind.o 
qes_write_module.o : qes_write_module.f90 qes_types_module.o 
qexsd_copy.o : qexsd_copy.f90 qes_types_module.o io_files.o kind.o 
qexsd.o : qexsd.f90 qes_libs_module.o qexsd_init.o qes_read_module.o clocks_handler.o qexsd_input.o qes_init_module.o qes_reset_module.o qes_write_module.o qes_types_module.o version.o mp_bands.o mp_pools.o mp_images.o mp_world.o input_parameters.o kind.o 
qexsd_init.o : qexsd_init.f90 noncol.o ions_base.o cell_base.o qes_libs_module.o mp_bands.o mp_pools.o mp_images.o mp_world.o constants.o qes_init_module.o qes_reset_module.o qes_types_module.o kind.o 
qexsd_input.o : qexsd_input.f90 qes_libs_module.o qes_types_module.o kind.o 
...
read_conf_from_file.o : read_conf_from_file.f90 qes_bcast_module.o qes_libs_module.o qes_types_module.o qexsd_copy.o qexsd.o mp_images.o mp.o io_files.o io_global.o constants.o kind.o 
read_file_new.o : read_file_new.f90 constants.o realus.o symm_base.o cell_base.o pwcom.o pwcom.o pwcom.o io_rho_xml.o scf_mod.o fft_base.o fft_rho.o recvec.o recvec_subs.o ions_base.o Coul_cut_2D.o esm.o ldaU.o funct.o newd.o paw_onecenter.o paw_init.o paw_variables.o uspp.o read_pseudo.o uspp.o kind.o pwcom.o gvecw.o recvec.o pw_restart_new.o wavefunctions.o pwcom.o noncol.o pwcom.o io_files.o buffers.o control_flags.o io_global.o 
...
run_pwscf.o : run_pwscf.f90 noncol.o pwcom.o ions_base.o constants.o kind.o newd.o exx_band.o exx.o exx_base.o fft_types.o atomic_wfc_mod.o funct.o qexsd.o qmmm.o fft_base.o pwcom.o scf_mod.o update_pot.o mp_images.o check_stop.o pwcom.o command_line_options.o pwcom.o control_flags.o cell_base.o upf_params.o parameters.o io_global.o 
...
setup.o : setup.f90 laxlib_hi.fh laxlib_mid.fh laxlib_param.fh laxlib_kinds.fh laxlib_low.fh laxlib.fh extfield.o fcp_variables.o paw_variables.o funct.o exx_base.o exx.o qes_types_module.o qes_libs_module.o qexsd_copy.o qexsd.o noncol.o pwcom.o pwcom.o mp.o mp_bands.o mp_pools.o mp_images.o pwcom.o bp_mod.o ldaU.o uspp.o uspp.o pwcom.o control_flags.o pwcom.o symm_base.o tetra.o start_k.o electrons_base.o pwcom.o pwcom.o recvec.o gvecw.o recvec.o atomic_wfc_mod.o ions_base.o cell_base.o io_files.o io_global.o parameters.o constants.o kind.o 
...
stress.o : stress.f90 esm.o tsvdw.o exx.o xdm_dispersion.o mm_dispersion.o uspp.o bp_mod.o symme.o funct.o control_flags.o scf_mod.o pwcom.o ldaU.o fft_base.o recvec.o pwcom.o constants.o ions_base.o cell_base.o kind.o io_global.o 
...
upf.o : upf.f90 pseudo_types.o upf_kinds.o 
...
wfcinit.o : wfcinit.f90 funct.o mp_bands.o random_numbers.o noncol.o recvec.o constants.o becmod.o kind.o qes_libs_module.o qes_types_module.o qexsd.o mp_images.o mp.o pw_restart_new.o pwcom.o wavefunctions.o uspp.o buffers.o io_files.o pwcom.o ldaU.o pwcom.o control_flags.o pwcom.o bp_mod.o atomic_wfc_mod.o io_global.o 
